...
namespace ICP_MPHYG02
{
    ...
    {
    public:
        ICPRegistration(bool ICP_FLAG = SURFACE_BASED_FLAG, int maxIter = 30, float errorThresh = 0.0001, float filterBadCorresp = 0.5);
        ...
        void solve(PointCloud& pFixedPCD,PointCloud& qMovingPCD,double& out_err, std::string& outputPath);
